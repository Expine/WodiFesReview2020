...
最初から最後まで、ずっとRPGしていた気分になったので最高。
敵のレベルカーブの見本市って感じで、だんだんしっかり雑魚も含めて敵が強くなっていく。武器の入れ替えをしっかりやらないと雑魚にすら屠られる。
武器をきちんと入れ替えつつ、適度に戦っていれば、ボス戦はきついながらも勝てる。この辺のバランスはかなりうまくできてる。

ただ、雑魚敵含めて強い攻撃振ってくるかの運ゲームな要素もちょっとあるのでご愛敬という感じ。

ストーリーは王道の風味漂ういいやつで、仲間キャラの掛け合いがフレーバーとして良い味を出しているのでとりあえず会話は全部回収しよう。そんなに多くはない。
筆者は入れ替えるのが面倒だったのもあって、スケット、マージョ、ガイのメンツで最後まで行ったけど、特に支障はなかった。
...
青鬼フォロワーかな。
このどこから現れるのかドキドキしながらマップを回るのが楽しい。
最初に置かれた紙の意味を回収するタイミングが絶妙に丁度いい。
最後の方だけ胸焼けしたのでもうちょいコンパクトにお願いしたい。青鬼だとあの面は、分かりやすく下方向に一度行くだけでよかったので。
...
レーン式リアルタイムバトルが楽しい。
行動のたびに変わるエレメントの状態や、此方のステータスなんかを加味してレーン移動して相手の攻撃を塞ぐのが楽しい。
リベンジ込みでないとほぼデバフはかけられないので、そのあたりをやりくりしつつ、溜まったリベンジでギリギリ逆転できた時は気持ちいい。

エレメントサーキットでいつでもステータスを割り振れるのが便利だし、組み合わせを考えるのが楽しい。スキルセットも同じ。
雑魚戦では攻撃重視のスピード決着タイプにしておいて、ボス戦では相手の弱点を考えつつ組み合わせを変えて試してみるのが良い。

メニューのUIが触っていて気持ちいい。最小レベルで気持ちいい程度にアニメーションしてくれる。
白が選択、灰が非選択でカーソルめいたものがないから、一つしか対象がない時に一瞬戸惑うけどそれくらい。
...
いろんなエリアがあったり、いろんなキャラがいたりで面白い。
結局猫が強くて猫で最後まで行ってしまった。
なんかついやりたくなる手軽さがある。
一番笑ったのは乙姫。
...
ちょっと昔のRPGをよりコンパクトにした感じ。
敵グラフィックがなんか不気味という感じで良い。

戦闘バランスは結構厳しめで、雑魚が硬いし強い。下手にパターン入るとボスより強い。
衰弱、毒、麻痺などの状態異常への回答が予防ではなく治療なので、全体にやられるとジリ貧。特に衰弱は致命傷になるので、祈るほかない。
そういう意味でも、確実に勝ちやすい雑魚でレベリングし、道中は全部逃げるが物凄い安定する。ボス戦前に回復とか甘いものはないので、ボス戦にはできる限り温存したいし。

きっちり硬くて強い雑魚がうようよいるという意味では、昔のFFを思い出す感じ。

個人的には、装備のレベルカーブに違和感は感じた。急に大分強くなったり、全然強くなかったり。購入前にパラメータ見たい。あと、最後の方のあの武器屋を用意するのはどうなんだろうとは思う。
同タイミングで、武器に関しては完全に空気になるんだけど。その一個先のダンジョンクリア後とかで良かったのでは。

あと、コンパクトにまとまりすぎていて、全然死んでも何とも思えなかった。こう、何というか状況だけドラマティックで、ドラマ自体はない感じ。結局あいつの目的は何だったんだ。
...
スコアが1単位刻みなのも、なんかもっと詰められそうな気分になってやりたくなる。
...
中華感とファンタジーが良くわからない融合を遂げた結果のカオスが良い。一部ストーリーではこれに現代まで混じってなおのことカオス。
ストリーミング=チャン思い出す。
このテンションだけで突っ切っていく感じ好き。

それぞれ別の方が作ったからなのか、シリアスに一瞬振れる場合もあれば、もう単純に勢いで突っ走っていくのもあって楽しい。
...
とにかくドット絵で描かれた風景がツボ。荒廃した世界、根に貫かれるビル、水の表現、全部好き。
ちょいちょい進むと朧気に見えてくる過去とか、こんな状況でものんびりしている動物とか、最高。
後半の方に出てくるあの動物が個人的には推し。背景含めて絵になっている。

美術館ネタも結構面白い。我が子を食らうサトゥルヌスかなあれ。
...
昨今のあれこれを彷彿とさせるネタが散りばめられていて良い。
最後の持って生き方も含めて秀逸。ついつい2度プレイして回収したくなってしまった。
不適切表現を探し回る姿はまさに、そういった人々を追体験しているようで恐ろしくもあり面白くもあり。
...
未知の暗号に出会った時にとりあえず色々試しつつ、方向性を見定めていくのが楽しい。
試行錯誤しつつ、閃いた時の快感はあるし、そういう難しめの暗号にはきっちりご褒美が用意されている辺りが良い。
一方で、なんか操作的に面倒な奴は半分くらいひどいのを掴まされたりするので注意。

最後の謎だけどうしても解けないので、空いた時間でやる。
...
序盤の方で、タコ殴りすれば良いんじゃないかなと思って集中砲火戦法をとっていると、後半の方で戦力差の前にひれ伏すことになるの面白い。
正しく勝つためには、槍を盾に、進行する騎兵を銃で止め、砲台の火力で遠くから殲滅するなど色々考えてプレイする必要があって楽しい。

ただの攻防戦だけでなく、シチュエーションや舞台がどんどん変わるのもやっていて楽しい。防衛戦、攻略戦、離脱戦、橋と川、その時々に応じて動き方も変わってくる。
それでも基本の考え方は変わらず、槍で止め、銃で士気を下げ、騎兵でとどめを刺せば大体うまくいく。そこまでもっていくのが楽しい。

部隊のクールタイムとか、移動頻度とか、諸々可視化されていないので、割と指示が通っているか不安に思うあたりはちょっと厳しかった。
ある意味指揮官の気持ちなのかもしれない。
...
敵のパターンに応じてフルーツとバリケードの二者択一を選んでいくのが楽しい。
敵の出現位置、強さ、密度なんかを鑑みて、うまいこと配置して刻限まで迎えられると達成感がある。
特に、畑目前で敵が力尽きるようにコントロールしたり、時間いっぱいまで逃げ切れるように配したりするのがはまると気持ちいい。

レベルカーブもかなり良くて、最初はチュートリアル的に少なく、後半は慣れてきても忙しないくらいに多い。

まだストーリーだけしかやってないけど、フリーとかサバイバルなら上位フルーツを置く機会もあるのかな。
...
めっちゃコンパクトながら、色々背景を想像できたりして楽しい。二人の関係性とか、過去とか。
色々なところ行くと、その辺の会話が発生して掛け合いが見れるので良い。
というかこの辺が全部よく感じるのは、大体キャラがきっちり魅力的に描けているからだったりする。

戦闘バランスも油断するとやられてしまったりするので、結構良いバランス。
...
結構難しい。プレイヤーの移動速度がめっちゃ遅く、かつショットガンだと更に遅くなるため、基本近接されたら負けなので。
せめてナイフ時くらいはもっと身軽にさせてほしい。移動にストレスを感じてしまう。

途中のパンダは本当に救世主って感じがした。
...
トゲとかを回避して上に登るというゲームデザイン自体はスマホの無料ゲームにあふれているけど、このゲームはそれにとどまってないので楽しい。

かすりシステムがあるおかげで、狙ってかすめていくことで序盤をスムーズに進めていくことができる。
ついでに言うと、後半くらいに狭いところを飛びぬけて行った時のグレイズが気持ちいというのもある。

あと、パンとトゲが絶妙に飴と鞭で、パンを欲張ってトゲに当たった時の何とも言えない感じが良い。下手って思わずつぶやいてしまう。

筆者は体力とかすりと食欲に全振りしていて、結構快適にプレイできました。ただ、最終スコアを高めるには回避に降っていかないとしんどいとは思う。
...
開幕に名前が出てきてウッとなったので、あの海外小説の最初の方にある人物表が欲しくなりました。りーどみーに突っ込んであるかなと思ったけどなかった。
...
キャラクターが個性的で、展開もテンポが良くて好きです。決め所はきっちり時間を使うのも良い。

ノーツベースの戦いでは、全弾パーフェクトでしのぎ切った時の、全部ジャストガードしたような気持ち良さがある。
敵の攻撃によってノーツの叩き方が違うので、必殺技の鬼のラッシュを全部防げるとより気持ちいい。
...
ぶっちゃけ運ゲー。パンしか来ない時とか、全然ジャンプしなくて良い時とかに高得点が来る。どうしようもない配置の時は、点が伸びない。
避けようと思ったら相手も同じタイミングでジャンプすることもあるし、しないこともある。唐突に急降下することもある。

ただ、そのへん含めてスピーディーに始まって終わるので、別に気にならないあたり良いゲーム。
...
光の醸し出す雰囲気が最高で、それだけでもやる価値のありそうなゲーム。
薄暗い屋敷の中、蝋燭を持って灯りを点けていくという不思議な体験ができる。
...
結構戦闘自体はシビアなので、4体の雑魚に絡まれたら厳しい。リターンも低い。なので、序盤は1~2体くらいしかいない時を狙って戦うようにしたほうが多分いい。
回復アイテムをほぼもらえないのもあり、最適行動は実質キュア連打。これをしないと、あっという間に体力を持っていかれる。

ラスボス含めて歯ごたえのある戦いが楽しめる。
...
ゲームとしての雰囲気や、絵の雰囲気、敵グラフィックの雰囲気とかは凄く良い。
エフェクトとかも凝っているし、印象としても整っている。

マップが物凄い単調なのと、戦闘バランスがどうしようもないのがつらい。
正しく武器を拾わない限り、ボスはほぼ相手にならない。
基本的に自主的にエンカウントしにいかない限りは、ほぼエンカウントしないので、素直な人は2回目のボスでいきなり詰む。
ラスボスは祈り。ここが正直苦痛だったので、バージョン落として強引にクリアした。ちなみにこっちは作業。
...
いろんなお化けが出てきて、全部統一された可愛いイラストになってて好き。
雰囲気とか、ちょっと差し挟まれるホラーな演出とかが凝っていて良い。

ちなみにマップは初めに確認しておいてメモ取る方針にしないと辛い。移動先を明記する機能が弱いので。

トゥルーエンドに行きたい気持ちはあったけど、今いけない理由がバグなのかこちらの手落ちなのか判断できなかったのでやめておいた。
...
ランゲームから簡易ガンシューティング、刹那の見切りまでいろいと遊べる。
クオリティは安定していて面白く、自分基準でクリアを設定して高スコアを目指そうとしてしまう。
...
ぼーっと見ていてつないでみたくなることもあれば、なんか適当につないでみたらそれっぽく見えることもあったりと発見がある。実際の星座の成り立ちはどっちなんだろうか。
